...
typedef enum esv_thing_model_msg_method {
    ...
    ESV_TMM_MTD_LAN_THING_SERVICE_PROPERTY_POSTREQ,
    ESV_TMM_MTD_WAN_THING_DISCOVERY,
    ESV_TMM_MTD_WAN_THING_DISCOVERY_REPLY,
    ESV_TMM_MTD_WAN_SUBTHING_THING_DISCOVERY,
    ESV_TMM_MTD_WAN_SUBTHING_THING_DISCOVERY_REPLY,
    ESV_TMM_MTD_WAN_SUBTHING_THING_CONFIG_PUSH,
    ESV_TMM_MTD_WAN_SUBTHING_THING_CONFIG_PUSH_REPLY,
    ESV_TMM_MTD_WAN_EASYHBES_THING_PLUGIN_NODE_CONFIG_PUSH,
    ESV_TMM_MTD_WAN_EASYHBES_THING_PLUGIN_NODE_CONFIG_PUSH_REPLY,
    ESV_TMM_MTD_WAN_SUBTHING_THING_PLUGIN_NODE_CONFIG_PUSH,
    ESV_TMM_MTD_WAN_SUBTHING_THING_PLUGIN_NODE_CONFIG_PUSH_REPLY,
