...
typedef enum esv_thing_model_msg_method {
	ESV_TMM_MTD_SUBTHING_THING_EVENT_PROPERTY_POST = 0,
	ESV_TMM_MTD_SUBTHING_THING_SERVICE_PROPERTY_SET,
	ESV_TMM_MTD_SUBTHING_THING_SERVICE_PROPERTY_SET_REPLY,
	ESV_TMM_MTD_SUBTHING_THING_SERVICE_PROPERTY_GET,
	ESV_TMM_MTD_SUBTHING_THING_SERVICE_PROPERTY_GET_REPLY
